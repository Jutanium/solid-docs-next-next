...
We'll build an app and explore Solid along the way. We'll be building a "bookshelf" that lets you search a library database and add books to a list.
...
<Aside>
  ...
  Solid](/start-here/js-for-solid) if you need a
